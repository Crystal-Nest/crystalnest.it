...
`),t(),e(446,`
`)),r&2&&(m(409),d("data",b.xmlMavenPackageSnippet))},dependencies:[g,h,S,f,u,p,c,x],styles:["[_nghost-%COMP%]{height:100%;flex:1;padding:2rem 2rem 2rem .75rem;color:#e3e3e3}[_nghost-%COMP%]   h1[_ngcontent-%COMP%]{font-size:2em;font-weight:400}[_nghost-%COMP%] > a[_ngcontent-%COMP%]{display:flex;align-items:center;gap:.5rem;width:fit-content;margin-top:1rem;text-decoration:none;color:inherit}[_nghost-%COMP%] > a[_ngcontent-%COMP%]:first-child{margin-top:0}[_nghost-%COMP%] > a[_ngcontent-%COMP%] > mat-icon[_ngcontent-%COMP%]{visibility:hidden}[_nghost-%COMP%] > a[_ngcontent-%COMP%]:hover{filter:brightness(1.2)}[_nghost-%COMP%] > a[_ngcontent-%COMP%]:hover > mat-icon[_ngcontent-%COMP%]{visibility:visible}[_nghost-%COMP%] > mat-divider[_ngcontent-%COMP%]{margin:.125rem 0 1rem 1.5rem}[_nghost-%COMP%] > div[_ngcontent-%COMP%]{padding-left:2rem;line-height:1.5}[_nghost-%COMP%] > div[_ngcontent-%COMP%] > span[_ngcontent-%COMP%]{display:block}[_nghost-%COMP%] > div[_ngcontent-%COMP%] > ul[_ngcontent-%COMP%]{margin:.25rem 0}[_nghost-%COMP%] > div[_ngcontent-%COMP%] > ul[_ngcontent-%COMP%]   ul[_ngcontent-%COMP%]{margin-left:1rem}[_nghost-%COMP%] > div[_ngcontent-%COMP%] > ul[_ngcontent-%COMP%]   markdown[_ngcontent-%COMP%]{text-indent:1rem each-line}[_nghost-%COMP%] > div[_ngcontent-%COMP%] > *.eop[_ngcontent-%COMP%]{margin-bottom:.5rem}"]});let o=a;return o})();export{V as VersioningComponent};
